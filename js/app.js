...
document.addEventListener("DOMContentLoaded", function(){
    let progressBar = document.querySelector(".info-header__progress-bar-value");
...
let dayContent = +day.textContent;
let hoursContent = +hours.textContent;
let minutesContent = +minutes.textContent;
let secondContent = +second.textContent;
...
// function timer(day , hours , minutes , second) {
    ...
    function animOnScroll(params) {
        for (let index = 0; index < animItems.length; index++) {
            ...
            if (animItemHeight > window.innerHeight) {
                animItemPoint = window.innerHeight - window.innerWidth / animStart;
            }
